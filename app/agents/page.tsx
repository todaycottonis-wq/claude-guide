...
export default function Page() {
  return (
    <PageShell
      chapter="4장"
      title="에이전트 만들기"
      intro="‘에이전트’라고 하면 어쩐지 영화 속 비밀 요원 같지요. 하지만 클로드의 에이전트는 훨씬 친근해요. 한 줄로 말하면 ‘한 가지 일만 잘하는 클로드 친구를 우리가 직접 만들어 두는 일’이에요. 이 장에서는 왜 그런 친구가 필요한지부터, 처음 만드는 다섯 단계, 그리고 잘 쓰는 요령까지 천천히 같이 가요."
