...
export default function Page() {
  return (
    <PageShell
      chapter="5장"
      title="스킬 만들기"
      intro="스킬(Skill)은 ‘자주 하는 일의 사용설명서 묶음’이에요. 요리책 같은 거예요. 클로드는 평소엔 그냥 책장에 꽂아 두고, 그 일이 필요할 때만 알아서 펴 봐요. 이 장에서는 ‘에이전트와 무엇이 다른지’부터, 처음 만드는 5단계, 자주 만드는 스킬 다섯 가지까지 같이 갑니다."
